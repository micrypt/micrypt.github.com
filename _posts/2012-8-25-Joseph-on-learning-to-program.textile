...
summary: Documenting a journey into learning to program
---
...
I often get asked how I initially learned programming… to which the answer is sadly that I'm not completely certain. Although I've always been fascinated with making things, I'm uncertain when it finally clicked that computers could be used for things other than playing Prince of Persia. It'd be nice to if I had documented my efforts to learn, but I didn't. Sorry, world… I failed you. However, my deplorable memory need not be an impedance, as long as others document how they learn. Consequently, I've badgered a rather bright friend of mine, "Joseph":http://twitter.com/iamjosephbenson (a designer) into making a diary of how he's learning to program. What follows are his thoughts:

h2. Joseph

bq. "This will be very difficult at first, but stick with it. If you go through this book, and do each exercise for one or two hours a night, you will have a good foundation for moving onto another book. You might not really learn “programming” from this book, but you will learn the foundation skills you need to start learning the language." - Zed Shaw.
