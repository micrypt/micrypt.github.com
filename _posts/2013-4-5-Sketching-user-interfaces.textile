...
Well, now that you're done, there's nothing stopping you from shipping it off to "Dribbble":http://dribbble.com/micrypt or more importantly get it converted into code, test it out, and iterate until you've gotten it just right.
