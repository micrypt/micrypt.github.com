...
It's worth mentioning that these are heavily influenced by Tony Hulme's "Visualise Your Business Model In 15 Minutes Flat" HackFWD talk [5]. With that out of the way, let's get started.
...
h2. Visualising your business model

"__Innovation is always associated with chaos__" - Alex Osterwalder [3]
...
!(alpha)/images/iterate.png!

Here is "Joe Stump’s":http://twitter.com/joestump take on the process to building a successful startup [4]
...
As much as one might ignore it, there’s still the “sixth force”, the government or the public [1]. Some thought should be given to how these factors come into play in one’s business strategy.
...
fn1. Coyne, K.P. and Sujit Balakrishnan (1996),Bringing discipline to strategy, The McKinsey Quarterly, No.4.

fn2. Porter, M.E. (1979), How Competitive Forces Shape Strategy, Harvard business Review, March/April 1979.

h2. Talks

fn3. Osterwalder A. (2008), "Disruptive Models":http://youtu.be/HpuXRiAZSP8

fn4. Stump J. (2011), "Starting your Startup":http://slidesha.re/lByk3O

fn5. Hulme T.(2010), "Visualise Your Business Model In 15 Minutes Flat":http://vimeo.com/13888824
